      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <Image
              alt="wed"
              src="https://drive.google.com/uc?export=view&id=1ys5X34xjvG6o0o4HLuL_JDg_aqVHc6Ef"
              width={1000}
              height={1000}
          ...
          >
            <span
              ...
              className="text-blue-500 underline italic max-md:text-xs"
            >
              * mọi yêu thương nơi phương xa xin gửi về
            </span>
          </motion.div> */}
        </div>
        <motion.div
          ...
          className="mt-6 flex gap-6 items-center justify-center max-lg:gap-4 max-[32rem]:gap-2"
        >
